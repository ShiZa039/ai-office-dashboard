...
История релизов и план развития. Текущая версия — `v0.18.1`.
...
- [ ] **Цены Kimi-моделей** — дополнить `pricing.ts` (сейчас Kimi исключён из $-оценок); данные и парсинг Kimi-транскриптов — отдельная задача для Kimi Code.
