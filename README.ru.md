...
**Текущая версия:** `v0.14.0` · zero-config: поддержка двух CLI (Claude Code + Kimi Code), автоустановка хуков, авто-обнаружение агентов, динамические комнаты, реальные лимиты Pro/Max, экстренная остановка агентов, UI en/ru.
